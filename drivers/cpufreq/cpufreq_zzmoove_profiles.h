...
// NOTE: profile values in this version are specificly for the LG G2 mini!
static char profiles_file_version[20] = "0.3 beta8 g2m";
...
struct zzmoove_profile zzmoove_profiles[] = {
	{
		1,		// Default Profile
		"def",		// default settings as hardcoded in the governor (please don't remove this profile) - modified to use g2m freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
 ...
 */
	{
		2,
		"ybat",		// Yank555.lu Battery Profile (please don't remove this profile) - modified to use g2m freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
 ...
 */
	{
		3,
		"ybatext",	// Yank555.lu Battery Extreme Profile (please don't remove this profile) - modified to use g2m freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
 ...
 */
	{
		4,
		"zzperf",	// ZaneZam Performance Profile (please don't remove this profile) - modified to use g2m freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
 ...
 */
	{
		5,
		"zzrelax",	// ZaneZam Relax Profile (please don't remove this profile) - modified to use g2m freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
